...
class OneThirdImageTwoThirdTextCTType extends BaseContentType
{
    protected function addFields(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('side', ChoiceType::class, [
                    'choices' => array(
                        'Image on left' => OneThirdImageTwoThirdTextCT::IMAGE_ON_LEFT,
                        'Image on right' => OneThirdImageTwoThirdTextCT::IMAGE_ON_RIGHT
                    ),
                    'multiple' => false,
                    'expanded' => true,
