...
class Roles
{
    ...
    //CATEGORY MANAGEMENT
    const ROLE_OBJECT_CATEGORY_VIEWER = "ROLE_OBJECT_CATEGORY_VIEWER";
    const ROLE_OBJECT_CATEGORY_EDITOR = "ROLE_OBJECT_CATEGORY_EDITOR";

    //PRODUCT MANAGEMENT
    const ROLE_OBJECT_PRODUCT_VIEWER = "ROLE_OBJECT_PRODUCT_VIEWER";
    const ROLE_OBJECT_PRODUCT_EDITOR = "ROLE_OBJECT_PRODUCT_EDITOR";
